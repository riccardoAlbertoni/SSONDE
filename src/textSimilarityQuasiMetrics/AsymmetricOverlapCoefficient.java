...
package textSimilarityQuasiMetrics;
...
/**
 * This code has been modified by Riccardo  Albertoni to get an asymmetric evaluation for string, It was originally part of 
 ...
 * @version 1.1
 */
public final class AsymmetricOverlapCoefficient extends AbstractStringMetric implements Serializable {
     ...
     */
    public AsymmetricOverlapCoefficient() {
     ...
     */
    public AsymmetricOverlapCoefficient(final InterfaceTokeniser tokeniserToUse) {
    ...
    public String getShortDescriptionString() {
        return "AsymmetricOverlapCoefficient";
    }
    ...
    public String getLongDescriptionString() {
        return "Implements the Asymmtric Overlap Coefficient algorithm providing a similarity measure between two string where it is determined to what degree a string is a subset of another. It is asymmetric in the sense that if the first string is a subset of the second it returns 1";
    }
    ...
    public float getSimilarity(final String string1, final String string2) {
        ...
        return (float) (commonTerms) / ((float) termsInString1);
    }
