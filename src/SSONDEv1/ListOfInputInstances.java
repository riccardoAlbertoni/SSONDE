 ...
 * 
 *It is the interface to be extended if you want to  dynamically generate the list of instances on which to work out the similarity, 
 *
 *classes which implements  ListOfInputInstances must be specified JSON configuration files as "InstanceURIsClass"  
 * 
 */
public interface ListOfInputInstances {
	public abstract ArrayList<String> getListOfInstanceURIs(OntologyModel om);
