 ...
 *
 */
public class GetResearcherIMATIplusCoauthor implements ListOfInputInstances {
...
String query="	Select distinct ?x ?z  where"+ 
		...
		//test
//		a= new ArrayList <String>();
//		a.add("http://www.cnr.it/ontology/cnr/individuo/unitaDiPersonaleEsterno/ID3316");
//		a.add("http://www.cnr.it/ontology/cnr/individuo/unitaDiPersonaleEsterno/ID10846");
//		
		return a;
